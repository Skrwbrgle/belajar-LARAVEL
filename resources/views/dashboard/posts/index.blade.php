    ...
    <table class="table table-striped table-sm">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="/dashboard/posts/{{ $post->slug }}" class="badge bg-secondary d-flax"><i class="bi bi-eye"></i></a>
            <a href="/dashboard/posts/{{ $post->slug }}/edit" class="badge bg-secondary d-flax"><i class="bi bi-pencil-square"></i></a>
